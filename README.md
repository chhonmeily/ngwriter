...
To get you started you can simply clone the `ngwriter` repository and install the dependencies:

### Prerequisites

You need git to clone the `ngwriter` repository. You can get git from [here][git].

We also use a number of Node.js tools to initialize and test `ngwriter`. You must have Node.js
